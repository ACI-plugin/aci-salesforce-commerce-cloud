...
//ACI_19.1.0: START
/**
 * Handles redirect from ACI payment widget page
 *
 */
function redirectFromACI() {

    var ACI = require('*/cartridge/controllers/ACI');
    var ACIResponse = ACI.HandleACIRedirect();
    if(ACIResponse.error) {
        response.redirect(ACIResponse.errorRedirectURL);
        return;
    } else {
        submit();
    }
...
//ACI_19.1.0: START 
/** @see module:controllers/COSummary~Submit */
exports.ACIHostedPageSubmit = guard.ensure(['https'], submit);

/** @see module:controllers/COSummary~handleACIPaymentResponse */
exports.ACIRedirect = guard.ensure(['https'], redirectFromACI);
//ACI_19.1.0: END
